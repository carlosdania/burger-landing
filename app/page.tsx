    ...
    <section className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
        ...
        >
          ...
          <a
            href="#concurso"
            className="inline-flex items-center gap-2 rounded-full border border-border px-8 py-3.5 text-base font-medium text-foreground transition-all duration-300 hover:border-primary/50 hover:text-primary"
          >
...
function Historia() {
  ...
  return (
    <section id="historia" className="relative bg-surface-1 px-6 py-24 sm:py-32">
...
function Ingredientes() {
  ...
  return (
    <section id="ingredientes" className="relative bg-background px-6 py-24 sm:py-32">
        ...
        <div className="mt-16 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {ingredients.map((item, i) => (
            <motion.div
              ...
              className="group relative overflow-hidden rounded-lg border border-border/50 bg-surface-1 p-6 transition-all duration-300 hover:border-primary/30 hover:bg-surface-2"
            >
              {/* Accent line */}
              <div
